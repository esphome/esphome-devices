...
Content on devices.esphome.io is generated by [Astro](https://astro.build/) with the [Starlight](https://starlight.astro.build/) docs theme. Pages are written in Markdown which anyone can learn. How to add a new device is [documented here](https://devices.esphome.io/devices/adding-devices).
