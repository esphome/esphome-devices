...
batteries faster than the stock firmware. Power leads can be soldered onto the battery contacts and pass through a hole drilled into top cap.

#### Assembly
The oil gauge must be fully reassembled with all gaskets inplace in order for the vapor seal to be maintained.
