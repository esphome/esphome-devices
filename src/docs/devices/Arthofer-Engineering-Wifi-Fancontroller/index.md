...
![Wifi Fancontroller](Wifi-Fancontroller.jpg "Wifi Fancontroller")
...
1. Plug in the Fancontroller
2. Connect to Wifi "fancontroller-*"
3. Input WiFi credentials
4. Adopt Device in ESPHome / Homeassistant
