...
An ESP32C3 based device to read out the P1 port of a Smart Meter and send data via the available ethernet port, or wifi, to Home Assistant.
It has a passthrough port to connect another P1 device.
...
substitutions:
  ...
  device_description: "SlimmeLezer Pro (ESP32C3) module to read your smart meter"
  friendly_name: SlimmeLezer Pro
...
dashboard_import:
  package_import_url: github://zuidwijk/slimmelezer/pro/config-ethernet.yaml
...
dashboard_import:
  package_import_url: github://zuidwijk/slimmelezer/pro/config-wifi.yaml
